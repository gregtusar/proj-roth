...
-- ============================================
-- STAGE 6: Nickname Matching (GREG->GREGORY, etc)
-- ============================================
...
-- ============================================
-- STAGE 8: Handle Duplicate Matches (Keep Best Match)
-- ============================================
...
-- ============================================
-- STAGE 9: Create Final Donations Table
-- ============================================
...
-- ============================================
-- STAGE 10: Verification and Statistics
-- ============================================

-- Get matching statistics
SELECT 
  'Donation Matching Statistics (No ZIP)' AS metric,
...
-- Check TUSAR donations specifically
SELECT 
  'TUSAR Donations' as check_type,
  COUNT(*) as total_tusar,
  COUNT(master_id) as matched_tusar,
  ROUND(COUNT(master_id) * 100.0 / COUNT(*), 2) as match_rate_pct,
  STRING_AGG(DISTINCT match_method, ', ' ORDER BY match_method LIMIT 5) as methods_used
FROM `proj-roth.voter_data.donations`
WHERE original_full_name LIKE '%TUSAR%';

...
echo "==================================="
echo "OAuth Display Name Fix for Greywolf Analytica"
echo "==================================="
echo ""
...
echo "   - App name: Greywolf Analytica"
...
echo ""
echo "   Page 4 - Summary:"
echo "   - Verify 'App name' shows 'Greywolf Analytica'"
...
echo "   - Name: Greywolf Analytica Web Client"
...
if [[ $DEPLOY_CONFIRM == "y" ]]; then
    ...
    echo "4. It should now show 'Greywolf Analytica'"
else
...
echo ""
echo "==================================="
echo "If it STILL shows the URL instead of 'Greywolf Analytica':"

...
class StarRating extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "renderRatingContents", () => {
      ...
      const [Star, starProps] = (0, _overrides.getOverrides)(overrides.Item, _styledComponents.StyledStar);
      const ratings = [];
      // @ts-ignore
      const refs = [{
        current: null
      ...
      for (let x = 1; x <= numItems; x++) {
        ...
        /*#__PURE__*/
        // @ts-ignore
        React.createElement(Star, _extends({
          key: x,
          role: "radio",
          title: "rating"
          ...
          onFocus: (0, _focusVisible.forkFocus)(starProps, this.handleFocus),
          onBlur: (0, _focusVisible.forkBlur)(starProps, this.handleBlur)
        })));
      }
      return ratings;
    });

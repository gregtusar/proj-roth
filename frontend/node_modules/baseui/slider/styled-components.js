...
exports.Track = exports.TickBar = exports.Tick = exports.ThumbValue = exports.Thumb = exports.Root = exports.Mark = exports.InnerTrack = exports.InnerThumb = void 0;
...
const Track = exports.Track = (0, _styles.styled)('div', props => {
  const {
    $theme,
    $value = [],
    $disabled,
...
const InnerTrack = exports.InnerTrack = (0, _styles.styled)('div', props => {
  const {
    $theme,
    $value = [],
    $min,
  ...
  return {
    ...
    background: (0, _reactRange.getTrackBackground)({
      values: $value,
      colors: $value.length === 1 ? [$disabled ? colors.borderOpaque : colors.borderSelected, $disabled ? colors.borderStateDisabled : colors.borderOpaque] : [$disabled ? colors.borderStateDisabled : colors.borderOpaque, $disabled ? colors.borderOpaque : colors.borderSelected, $disabled ? colors.borderStateDisabled : colors.borderOpaque],
      min: $min || 0,
      max: $max || 0,
      rtl: direction === 'rtl'
    }),
...
const Mark = exports.Mark = (0, _styles.styled)('div', props => {
  return {
    width: '4px',
    height: '2px',
...
const Tick = exports.Tick = (0, _styles.styled)('div', props => {
  return {
...
const TickBar = exports.TickBar = (0, _styles.styled)('div', props => {
  const {
    $theme
  } = props;
  const {
...
const Thumb = exports.Thumb = (0, _styles.styled)('div', props => {
  const {
    $theme,
    $value = [],
    $thumbIndex,
  ...
  return {
    ...
    outline: 'none',
    boxShadow: props.$isFocusVisible ? `0 0 0 3px ${$theme.colors.borderAccent}` : '0 1px 4px rgba(0, 0, 0, 0.12)',
    cursor: $disabled ? 'not-allowed' : 'inherit'
  };
});
...
const InnerThumb = exports.InnerThumb = (0, _styles.styled)('div', props => {
  const {
    $disabled,
    $theme
  } = props;
...
const ThumbValue = exports.ThumbValue = (0, _styles.styled)('div', props => {
  const {
    $disabled,
    $theme
  } = props;
